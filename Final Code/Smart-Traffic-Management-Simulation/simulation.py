...
defaultGreen = {0:60, 1:60, 2:60, 3:60}
defaultRed = 150
defaultYellow = 5
...
currentGreen = int(arguments[index])-1
index += 1
nextGreen = int(arguments[index])-1
index += 1
...
def initSignal():
    ...
    for i in range(1,5):
        if(i == int(arg1)):
            #print('if {}'.format(i-1))
            signals.append(TrafficSignal(0, defaultYellow, defaultGreen[i-1]))
        else:
            #print('else {}'.format(i-1))
            signals.append(TrafficSignal(defaultRed, defaultYellow, defaultGreen[i-1]))
...
def repeat():
    global currentGreen, currentYellow, nextGreen, changeInRender, index
...
class Main:
    ...
    while True:
        ...
        lane1 = font.render("Lane 1", True, black, white)
        lane2 = font.render("Lane 2", True, black, white)
        lane3 = font.render("Lane 3", True, black, white)
        lane4 = font.render("Lane 4", True, black, white)
        screen.blit(lane1,(430,290))
        screen.blit(lane2,(870,290))
        screen.blit(lane3,(870,580))
        screen.blit(lane4,(430,580))
